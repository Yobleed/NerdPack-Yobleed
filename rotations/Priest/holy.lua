...
local Potions = {
	{'#Healthstone', 'UI(p_HS) & player.health <= UI(p_HSspin)'},
	{'#Ancient Healing Potion', 'UI(p_AHP) & player.health <= UI(p_AHPspin)'},
	{'#Ancient Mana Potion', 'UI(p_AMP) & player.mana <= UI(p_AMPspin)'},
}
